...
summary: 'My first solo web project after finishing a coding bootcamp & CAN Borneo'
...
<Image
  alt={`banner`}
  src={`/static/images/jamstack-canborneo/canborneo-greenbkg-thin.jpg`}
  width={1000}
  height={240}
/>
...
<Image
  alt={`banner`}
  src={`/static/images/jamstack-canborneo/20190519_102904_0023.jpg`}
  width={1000}
  height={563}
/>
...
<Image
  alt={`banner`}
  src={`/static/images/jamstack-canborneo/canborneo-home.png`}
  width={1000}
  height={550}
/>
Built using Gatsby on Netlify, this little JAMstack project was made to replace CAN Borneo's previous Google Blogspot site. I used it as an opportunity to experiment with design by making something a little unconventional, based around a background of rotating blurred images and scrollable card components sitting on top.
