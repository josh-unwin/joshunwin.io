...
summary: 'A look at Signal messenger'
publishedAt: '2019-02-08'
image: '/static/images/blog/signal/signal-header.png'
categories:
  - 'Tech'
---
...
<Image
  alt={`banner`}
  src={`/static/images/blog/signal/signal-header.png`}
  width={1200}
  height={600}
/>
...
### Telegram stores your messages on their servers.
...
From a usability and feature standpoint, Signal is most comparable to WhatsApp. It too uses your phone number to find your friends and offers the follows functionality & more:
...
* Voice & video calls for individual and group chats
* iPad app
* Reactions
* Sticker packs
* Modern design
